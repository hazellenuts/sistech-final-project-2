        ...
        <div>
            ...
            <main className="w-screen  flex flex-col justify-between bg-gray-100 text-black">
                <div className="flex flex-col items-center justify-center p-10 bg-gray-200 h-[250px]">
                    <h1 className="font-bold text-ocean-600 text-3xl">News</h1>
                    <p className="font-semibold text-center">Get the latest news and insights from Japan. Explore top stories updated daily for learners and enthusiasts of Japanese culture.</p>
                </div>
